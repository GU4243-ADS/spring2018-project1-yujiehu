...
After checking their ingradients, what did they put for the "Flavour"? The bar plot shows the authors with the Total Number of Commas, SemiColons, Colons, Questions used by them. Still, be careful because EAPs sentence appeared more ofen than others.
...
Calculated sentiment scores for each sentence and showed the highest 10 score among all sentences
...
```
*EAP is way more positive tham other authors over the setence level. Sentences with the highest score are:
